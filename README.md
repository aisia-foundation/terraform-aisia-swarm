...
> **v6.12.75** — module cœur — déployer AISIA sur Docker Swarm existant
...
| `image_tag` | string | `v6.12.75` | Tag d'image (manifest multi-arch requis) |
...
| `image_tag` | `string` | `"v6.12.75"` | Tag d'image AISIA à déployer (ex. v6.12.75). Doit être un manifest multi-arch (arm64 + amd64). |
